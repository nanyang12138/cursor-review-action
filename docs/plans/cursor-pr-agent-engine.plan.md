...
- `v0.5` fixture volume gate 已由 15 个 no-Cursor concrete fixtures 覆盖，其中
  ...
  deleted-only 与 generated/lockfile 夹具已验证 anchor/skipped-file evidence；
  `v1` 仍需继续扩展到 20 个，优先补齐 config-only/renamed/many-small-file
