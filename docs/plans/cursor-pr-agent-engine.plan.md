...
- `v0.5` fixture volume gate 已由 13 个 no-Cursor concrete fixtures 覆盖，其中
  ...
  `v1` 仍需继续扩展到 20 个，优先补齐 generated/config-only/deleted-only/renamed/
  many-small-file 与 dogfooding-derived final-product 案例。
